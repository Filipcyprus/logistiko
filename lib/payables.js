...
import { purchaseTotal as grossPurchaseTotal } from "@/lib/purchaseMath";
...
// Το σύνολο που οφείλεται στον προμηθευτή = καθαρό + ΦΠΑ (βλ. lib/purchaseMath.js).
export function purchaseTotal(po) {
  return grossPurchaseTotal(po);
}
