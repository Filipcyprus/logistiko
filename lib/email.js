...
export function buildEmail({ kind, doc, settings, lang }) {
  ...
  const subjectKey = { invoice: "email.subjectInvoice", credit: "email.subjectCredit", quote: "email.subjectQuote", order: "email.subjectOrder", purchase: "email.subjectPurchase" }[kind] || "email.subjectInvoice";
  const bodyKey = { invoice: "email.bodyInvoice", credit: "email.bodyCredit", quote: "email.bodyQuote", order: "email.bodyOrder", purchase: "email.bodyPurchase" }[kind] || "email.bodyInvoice";
  const docLabel = { invoice: doc.type === "timologio" ? t("invoices.docInvoice") : t("invoices.docReceipt"), credit: t("invoices.docCredit"), quote: t("documents.quoteLabel"), order: t("documents.orderLabel"), purchase: t("purchases.poTitle") }[kind];
