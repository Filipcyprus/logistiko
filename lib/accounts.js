...
export const SEED_ACCOUNTS = [
  ...
  // Συνηθισμένες κατηγορίες εξόδων — ΔΕΝ είναι συστημικές, ο χρήστης μπορεί να τις σβήσει.
  { number: "5200", type: "expense", nameKey: "coa.rent" },
  { number: "5300", type: "expense", nameKey: "coa.utilities" },
  { number: "5400", type: "expense", nameKey: "coa.wages" },
