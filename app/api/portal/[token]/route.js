...
export async function GET(_req, { params }) {
  ...
  // Προϊόν χωρίς τιμή (0€) δεν εμφανίζεται ποτέ στον πελάτη — εκτός αν ο ιδιοκτήτης του έβαλε ειδική τιμή.
  // (Έτσι νέα προϊόντα που δεν έχουν ακόμα τιμή χονδρικής δεν βγαίνουν στη σελίδα παραγγελιών με 0,00 €.)
  products = products.filter((p) => p.hasCustomPrice || Number(p.price) > 0);
