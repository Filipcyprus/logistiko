...
export async function PUT(request, { params }) {
  ...
  // Ημερολόγιο Κινήσεων (/api/journal) για να αναγνωρίσει με ποιον λογαριασμό πιστώθηκε η αγορά
  // (Ταμείο ή Τράπεζα), χρεώνοντας το Απόθεμα ανά είδος με βάση το unitCost. Το συνημμένο τιμολόγιο
  // του προμηθευτή μένει πάνω στην ίδια την Παραγγελία, για αναφορά.
